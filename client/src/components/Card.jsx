...
const Card = ({user}) => {
  ...
  const handleAlert=(err)=>{
    ...
    const handleReject=async()=>{
        try{
          await axios.put(`https://velle-wtov.onrender.com/api/users/reject/${user._id}`,{},{headers:{Authorization:"Bearer "+currentUser.jwt}});
      ...
      const handleRequest=async()=>{
        await axios.put(`https://velle-wtov.onrender.com/api/users/request/${user._id}`,{},{headers:{Authorization:"Bearer "+currentUser.jwt}});
      ...
      const handleAccept=async()=>{
        try{
            await axios.put(`https://velle-wtov.onrender.com/api/users/accept/${user._id}`,{},{headers:{Authorization:"Bearer "+currentUser.jwt}});
